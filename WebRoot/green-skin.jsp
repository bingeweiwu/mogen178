                        ...
                        <header>
                                <div class="container">
                                        ...
                                        <div class="logo-container">
                                                <!-- Website Logo -->
                                                <a href="index-2.jsp"  title="Knowledge Base Theme">
                                        ...
                                        <nav class="main-nav">
                                                <div class="menu-top-menu-container">
                                                        <ul id="menu-top-menu" class="clearfix">
                                                                ...
                                                                <li><a href="home-categories-description.jsp">Home 2</a></li>
                                                                <li><a href="home-categories-articles.jsp">Home 3</a></li>
                                                                <li><a href="articles-list.jsp">Articles List</a></li>
                                                                <li><a href="faq.jsp">FAQs</a></li>
                                                                <li><a href="#">Skins</a>
                                                                        <ul class="sub-menu">
                                                                                <li><a href="blue-skin.jsp">Blue Skin</a></li>
                                                                                <li class="current-menu-item"><a href="green-skin.jsp">Green Skin</a></li>
                                                                ...
                                                                <li><a href="#">More</a>
                                                                        <ul class="sub-menu">
                                                                                ...
                                                                                <li><a href="page.jsp">Sample Page</a></li>
                                                                        </ul>
                                                                </li>
                                                ...
                                                <div class="row separator">
                                                        <section class="span4 articles-list">
                                                                ...
                                                                <ul class="articles">
                                                                        <li class="article-entry standard">
                                                                                <h4><a href="single.jsp">Integrating WordPress with Your Website</a></h4>
                                                                                <span class="article-meta">25 Feb, 2013 in <a href="#" title="View all posts in Server &amp; Database">Server &amp; Database</a></span>
                                                                                <span class="like-count">66</span>
                                                                        </li>
                                                                        <li class="article-entry standard">
                                                                                <h4><a href="single.jsp">WordPress Site Maintenance</a></h4>
                                                                                <span class="article-meta">24 Feb, 2013 in <a href="#" title="View all posts in Website Dev">Website Dev</a></span>
                                                                                <span class="like-count">15</span>
                                                                        </li>
                                                                        <li class="article-entry video">
                                                                                <h4><a href="single.jsp">Meta Tags in WordPress</a></h4>
                                                                                <span class="article-meta">23 Feb, 2013 in <a href="#" title="View all posts in Website Dev">Website Dev</a></span>
                                                                                <span class="like-count">8</span>
                                                                        </li>
                                                                        <li class="article-entry image">
                                                                                <h4><a href="single.jsp">WordPress in Your Language</a></h4>
                                                                                <span class="article-meta">22 Feb, 2013 in <a href="#" title="View all posts in Advanced Techniques">Advanced Techniques</a></span>
                                                                                <span class="like-count">6</span>
                                                                        </li>
                                                                        <li class="article-entry standard">
                                                                                <h4><a href="single.jsp">Know Your Sources</a></h4>
                                                                                <span class="article-meta">22 Feb, 2013 in <a href="#" title="View all posts in Website Dev">Website Dev</a></span>
                                                                                <span class="like-count">2</span>
                                                                        </li>
                                                                        <li class="article-entry standard">
                                                                                <h4><a href="single.jsp">Validating a Website</a></h4>
                                                        ...
                                                        <section class="span4 articles-list">
                                                                ...
                                                                <ul class="articles">
                                                                        ...
                                                                        <li class="article-entry standard">
                                                                                <h4><a href="single.jsp">Using Javascript</a></h4>
                                                                        ...
                                                                        <li class="article-entry image">
                                                                                <h4><a href="single.jsp">Using Images</a></h4>
                                                                        ...
                                                                        <li class="article-entry video">
                                                                                <h4><a href="single.jsp">Using Video</a></h4>
                                                                        ...
                                                                        <li class="article-entry standard">
                                                                                <h4><a href="single.jsp">WordPress CSS Information and Techniques</a></h4>
